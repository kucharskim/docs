...
- [Korean](/docs/roles/validator/staking-kr)
...
To learn more about how validators are chosen, take a look at the [Validator FAQ](/docs/roles/validator/validator-faq).
