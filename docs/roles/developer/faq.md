...
You can read more about our consensus strategy on our [Validator Quickstart](/docs/roles/validator/staking-overview) and [Validator FAQ](/docs/roles/validator/validator-faq).
